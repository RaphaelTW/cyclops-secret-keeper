    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <Button style={styles.btn} title="Editar" onPress={handleEditar} color="#008000" />
                <Button style={styles.btn} title="Excluir" onPress={handleExcluir} color="#FF0000" />
                <Button style={styles.btn} title="Voltar" onPress={handleVoltar} color="#0084ff" />
            </View>
        </View>
    );
};
